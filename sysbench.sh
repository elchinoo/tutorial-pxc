#!/bin/bash
sysbench /usr/share/sysbench/oltp_read_write.lua --threads=4 --mysql-host=192.168.200.21 --mysql-user=sbtest --mysql-password=sbtestPasswd --mysql-port=3306 --tables=20 --table-size=10000000 prepare
